<?php
/**
 * Template Name: Content - General - International
 * Description: General content page for the international base site
 */
?>
<!doctype html>
<html <?php priorclave_lang(); ?>>
  ...
  <body <?php body_class('content content--general'); ?>>
    <header>
      <?php
        get_partial('navigation/simplified'); // Primary navigation
