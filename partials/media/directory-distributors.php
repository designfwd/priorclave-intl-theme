...
<section class="o-distributors">
              ...
              <div class="m-distributorCountry__content">
                ...
                <address class="m-distributorCountry__content--address">
                  <?php
                          ...
                          if (
                            get_field('city', $distributor->ID) && (get_field('state', $distributor->ID) ||
  ...
  ?>
  <dialog id="dialog-form" class="m-distributorDialog">
    ...
    <div class="m-distributorDialog__form">
      ...
      echo do_shortcode('[gravityforms ajax=true id=' . $form . ']');
      switch_to_blog(1);
      ?>
    </div>
  </dialog>
