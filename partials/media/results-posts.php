  ...
  ?>
    <div class="o-articleGrid__article">
      <div class="m-articlePreview m-articlePreview--blog" data-href="<?php the_permalink(); ?>">
          ...
          <img class="m-articlePreview__photo lazyload" src="<?php echo get_avatar_url(get_the_ID(), array('size'=>72)); ?>" />
          <h3 class="m-articlePreview__headline" href="<?php echo the_permalink(); ?>"><?php the_title(); ?></h3>
